...
VALUES ('filament z³oty 500g', 3, to_date('20-01-2019', 'DD-MM-YYYY'), 50.00);
...
INSERT INTO material (name, quantity, purchase_date, price) 
VALUES ('Poliwêglan 5mm 1000x1000', 4, to_date('12-08-2019', 'DD-MM-YYYY'), 150.00);

INSERT INTO material (name, quantity, purchase_date, price) 
VALUES ('Poliwêglan 4mm 1000x1000', 3, to_date('12-08-2020', 'DD-MM-YYYY'), 140.00);

INSERT INTO material (name, quantity, purchase_date, price) 
VALUES ('Poliwêglan 3mm 1000x1000', 2, to_date('07-07-2018', 'DD-MM-YYYY'), 130.00);

INSERT INTO material (name, quantity, purchase_date, price) 
VALUES ('P³yta OCB 6mm 2500x1200', 3, to_date('13-05-2018', 'DD-MM-YYYY'), 200.00);
